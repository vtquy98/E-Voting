...
import {
  getSystemStats,
  getSystemStatsDataSelector
} from '../stores/ElectionState';

const connectToRedux = connect(
  createStructuredSelector({
    systemStats: getSystemStatsDataSelector
  }),
  dispatch => ({
    getSystemStats: () => {
            ...
            <div className="row justify-content-center">
              <div className="col-lg-9">
                ...
                >
                  ...
                  <h3 className="title">
                    <span>Our has been working to create this system to </span>{' '}
                  ...
                  <div className="single-service d-flex">
                    ...
                    <div className="service-content media-body">
                      ...
                      <p className="text">
                        ...
                        sending of notices and ballot papers and receiving the
                        said ballot votes. Increase people participation in any
                        meetings.
                      </p>
                    </div>
                ...
                <div className="col-lg-4 col-md-7">
                  <div className="single-service service-border d-flex">
                    ...
                    <div className="service-content media-body">
                      ...
                      <p className="text">
                        Facilitate electronic voting on resolutions of
                        organizations in a fair and transparent manner for all
                        classes of security/stakeholders, using blockchain.
                      </p>
                    </div>
                ...
                <div className="col-lg-4 col-md-7">
                  <div className="single-service d-flex">
                    ...
                    <div className="service-content media-body">
                      ...
                      <p className="text">
                        A blockchain is a good tool to make the tallying
                        procedure public, as long as the votes are recorded in
                        incontrovertible anonymity. This could be implemented
                        through a virtual ballot box, which should be kept
                        secured from possible attacks. Cryptographic tools may
            ...
            <div className="row justify-content-between">
              <div className="col-xl-5 col-lg-6">
                ...
                >
                  ...
                  <p className="text">
                    After experiencing the system trial, they have some comments
                    as follows:
                  </p>
                </div>
              </div>
                  ...
                  <div className="testimonial-content-wrapper testimonial-active">
                    <div className="single-testimonial">
                      <div className="testimonial-text">
                        <p className="text">
                          “This application is easy to use, beautiful interface,
                          and easy to interact. I like it so much.”
                        </p>
                      </div>
              ...
              <div className="col-lg-12">
                ...
                >
                  <h4 className="contact-title pb-10">
                    <i className="lni-envelope"></i> Leave{' '}
                    <span>A Message.</span>
                  </h4>
...
export default connectToRedux(HomepageComponent);
